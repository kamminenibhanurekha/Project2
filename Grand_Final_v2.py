...
conn_str = (
    ...
    'SERVER=p2imagefakedetection1.database.windows.net;'  # SQL Server name
    'DATABASE=p2imagefakedetection;'  #  database name
    'UID=bhanurekha;'  # SQL Server username
    'PWD=Bhanu@454;'  # SQL Server password
)
...
CUSTOM_VISION_ENDPOINT = "https://p2customvisionpj-prediction.cognitiveservices.azure.com/"
CUSTOM_VISION_PREDICTION_KEY = "812689930bab47dba5ce68454c35f964"
CUSTOM_VISION_PROJECT_ID = "ffed8612-6347-40b8-b624-7e4f85dd9dc4"
CUSTOM_VISION_PUBLISHED_NAME = "fakeimagedetection"

COMPUTER_VISION_ENDPOINT = "https://bhanukam1.cognitiveservices.azure.com/"
COMPUTER_VISION_KEY = "d50119f0bd254ee293f0315657f6b31a"

SPEECH_KEY = "d4b57dfb5b874573b629372da90ae48b"

TRANSLATOR_ENDPOINT = "https://bhanukam3.cognitiveservices.azure.com/"
TRANSLATOR_KEY = "d9bae113c27846b6b14ec5b7983db18e"
...
def translate_text(text, target_language="hi"):
    ...
    response = translator_client.translate(body, to_language=[target_language])
